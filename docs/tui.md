...
## Core component contract (`@xcsh/pi-tui`)
...
import { SelectList, matchesKey, replaceTabs, truncateToWidth } from "@xcsh/pi-tui";
import { getSelectListTheme, type ExtensionAPI } from "@xcsh/pi-coding-agent";
