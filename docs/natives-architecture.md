...
`@xcsh/pi-natives` is a three-layer stack:
...
**Guaranteed contract (API-facing):** consumers import from `@xcsh/pi-natives` and use typed wrappers.
...
1. Consumer imports from `@xcsh/pi-natives`.
