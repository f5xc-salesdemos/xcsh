...
This runbook describes how the `@xcsh/pi-natives` build pipeline produces `.node` addons, how compiled distributions load them, and how to debug loader/build failures.
