...
import type { InteractiveModeContext } from "@f5xc-salesdemos/pi-coding-agent/modes/types";
import { executeBuiltinSlashCommand } from "@f5xc-salesdemos/pi-coding-agent/slash-commands/builtin-registry";
