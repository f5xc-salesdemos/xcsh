...
import { handleAur } from "@xcsh/pi-coding-agent/web/scrapers/aur";
import { handleBrew } from "@xcsh/pi-coding-agent/web/scrapers/brew";
import { handleMaven } from "@xcsh/pi-coding-agent/web/scrapers/maven";
import { handleNuGet } from "@xcsh/pi-coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@xcsh/pi-coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@xcsh/pi-coding-agent/web/scrapers/rubygems";
