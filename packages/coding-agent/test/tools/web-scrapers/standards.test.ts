...
import { handleCheatSh } from "@xcsh/pi-coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@xcsh/pi-coding-agent/web/scrapers/rfc";
import { handleTldr } from "@xcsh/pi-coding-agent/web/scrapers/tldr";
