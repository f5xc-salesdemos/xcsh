...
import { handleArtifactHub } from "@xcsh/pi-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@xcsh/pi-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@xcsh/pi-coding-agent/web/scrapers/discogs";
