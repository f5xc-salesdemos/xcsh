...
import { handleBiorxiv } from "@xcsh/pi-coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@xcsh/pi-coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@xcsh/pi-coding-agent/web/scrapers/wikidata";
