...
import { type AuthCredential, AuthCredentialStore, type StoredAuthCredential } from "@xcsh/pi-ai";
import { getAgentDbPath, isRecord, logger } from "@xcsh/pi-utils";
 ...
 * Delegates auth credential operations to AuthCredentialStore from @xcsh/pi-ai.
