 ...
 */
import type { AgentEvent, AgentMessage, ResolvedThinkingLevel, ThinkingLevel } from "@xcsh/pi-agent-core";
import type { Model } from "@xcsh/pi-ai";
import type { AgentSession, AgentSessionEvent, AuthStorage, SessionStats } from "@xcsh/pi-coding-agent";
import {
...
export async function discoverSharedInfra(options: DiscoverSharedInfraOptions = {}): Promise<SharedInfra> {
	const { ModelRegistry: MR } = await import("@xcsh/pi-coding-agent");
