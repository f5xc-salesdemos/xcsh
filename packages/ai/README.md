...
```bash
npm install @f5xc-salesdemos/pi-ai
```

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from "@f5xc-salesdemos/pi-ai";
...
```typescript
import { Type, Tool, StringEnum } from "@f5xc-salesdemos/pi-ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@f5xc-salesdemos/pi-ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@f5xc-salesdemos/pi-ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@f5xc-salesdemos/pi-ai";
...
```typescript
import { getModel, stream } from "@f5xc-salesdemos/pi-ai";
...
```typescript
import { getProviders, getModels, getModel } from "@f5xc-salesdemos/pi-ai";
...
```typescript
import { Model, stream } from "@f5xc-salesdemos/pi-ai";
...
```typescript
import { getModel, complete, Context } from "@f5xc-salesdemos/pi-ai";
...
```typescript
import { Context, getModel, complete } from "@f5xc-salesdemos/pi-ai";
...
bunx @f5xc-salesdemos/pi-ai login vllm         # store vLLM API key (or placeholder for local no-auth)
bunx @f5xc-salesdemos/pi-ai list               # list available providers
```
...
```typescript
import { loginGitHubCopilot } from "@f5xc-salesdemos/pi-ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@f5xc-salesdemos/pi-ai";
import * as fs from "node:fs";
