...
```bash
npm install @xcsh/pi-ai
```

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from "@xcsh/pi-ai";
...
```typescript
import { Type, Tool, StringEnum } from "@xcsh/pi-ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@xcsh/pi-ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@xcsh/pi-ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@xcsh/pi-ai";
...
```typescript
import { getModel, stream } from "@xcsh/pi-ai";
...
```typescript
import { getProviders, getModels, getModel } from "@xcsh/pi-ai";
...
```typescript
import { Model, stream } from "@xcsh/pi-ai";
...
```typescript
import { getModel, complete, Context } from "@xcsh/pi-ai";
...
```typescript
import { Context, getModel, complete } from "@xcsh/pi-ai";
...
```bash
bunx @xcsh/pi-ai login              # interactive provider selection
bunx @xcsh/pi-ai login anthropic    # login to specific provider
bunx @xcsh/pi-ai login vllm         # store vLLM API key (or placeholder for local no-auth)
bunx @xcsh/pi-ai list               # list available providers
```
...
```typescript
import { loginGitHubCopilot } from "@xcsh/pi-ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@xcsh/pi-ai";
import * as fs from "node:fs";
